...
_G.packer_plugins = {
  ...
  ["inc-rename.nvim"] = {
    loaded = true,
    path = "/home/cristian/.local/share/nvim/site/pack/packer/start/inc-rename.nvim",
  ...
  ["telescope-ui-select.nvim"] = {
    loaded = true,
    path = "/home/cristian/.local/share/nvim/site/pack/packer/start/telescope-ui-select.nvim",
